For each context file in this directory, run [prose output] to check the model and properties output, then run [prose verify] to verify the properties using PRISM.
  ...
  *)
  ...
  module w3
    ...
    [] (w3=7) & (fail=false) -> 1:(fail'=true);
    [w3_w2] (w3=0) & (fail=false) -> 0:(w3'=7) + 1:(w3'=1);
    [w3_w2_req_unit] (w3=1) & (fail=false) -> 1:(w3'=2);
    [w2_w3] (w3=2) & (fail=false) -> 1:(w3'=3);
    [w2_w3_res_int] (w3=3) & (fail=false) -> 1:(w3'=4);
    [w2_w3_err_unit] (w3=3) & (fail=false) -> 1:(w3'=6);
    [w3_dummy] (w3=4) & (fail=false) -> 0:(w3'=7) + 1:(w3'=5);
    [w3_dummy_done_unit] (w3=5) & (fail=false) -> 1:(w3'=4);
  endmodule
  ...
  module dummy
    ...
    [] (dummy=3) & (fail=false) -> 1:(fail'=true);
    [w3_dummy] (dummy=0) & (fail=false) -> 1:(dummy'=1);
    [w3_dummy_done_unit] (dummy=1) & (fail=false) -> 1:(dummy'=0);
  endmodule
  
  label "end" = (w0=5) & (w1=11) & (w2=11) & (w3=6) & (dummy=2);
  ...
  label "cando_w3_dummy_done_unit" = w3=4;
